...
Hình trên là một kernel nhân ma trận cơ bản. Vì chúng ta đang tạo ra một mảng đầu ra P hai chiều, chúng ta có thể chỉ cần một luồng để tạo ra một phần tử của mảng đầu ra P. Điều này tương tự như kernel làm mờ hình ảnh ()