...
- Trong hình, chúng ta thấy rằng khối (0,0) ánh xạ đến góc trên bên trái của ma trận kết quả, bao gồm các phần tử P00,P01,P10,P11​. Trong khối (0,0), mỗi luồng đảm nhận một phần tử: luồng (0,0) ánh xạ đến P00P00​, luồng (1,0) ánh xạ đến P10, v.v.