...
- Trong hình, chúng ta thấy rằng khối (0,0) ánh xạ đến góc trên bên trái của ma trận kết quả, bao gồm các phần tử P(0,0), P(0,1), P(1,0), P(1,1)​. Trong khối (0,0), mỗi luồng đảm nhận một phần tử: luồng (0,0) ánh xạ đến P00P00​, luồng (1,0) ánh xạ đến P10, v.v.