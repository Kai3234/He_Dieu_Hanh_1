...
- Đây là sơ đồ minh hoạ về cấu trúc ma trận trong phép nhân ma trận, với các ma trận M, N và P, trong đó P = M * N. Sơ đồ cho thấy cách chia ma trận thành các khối với BLOCK_WIDTH và thực hiện tính toán song song. Trong đó: 
