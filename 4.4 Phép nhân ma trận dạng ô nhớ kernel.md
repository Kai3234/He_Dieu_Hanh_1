...
- [[đồng bộ rào cản (barrier synchronization)]] và [[bộ nhớ chia sẻ]]
- Cân nhắc về tài nguyên
 - Đơn giản hóa bằng việc giả sử chiều rộng là bội số của [[kích thước ô nhớ]]
# nhân ma trận dạng ô nhớ theo giai đoạn cụ thể [[pha (phase)]]
## [[pha (phase)]] 0
...
# Cân nhắc về kích thước [[ô nhớ]] ([[khối luồng (thread block)]])
...
- Đối với SM có [[bộ nhớ chia sẻ]] 16KB
	...
	- Đối với [[bộ nhớ chia sẻ]] 16KB, người ta có thể có tối đa 8 [[khối luồng (thread block)]] thực thi:
...
- Mỗi __syncthread() có thể giảm số lượng [[luồng (thread)]] hoạt động cho một khối:
