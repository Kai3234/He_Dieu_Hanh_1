...
- Các [[luồng (thread)]] thực hiện lại quá trình tải dữ liệu.
...
- [[Bộ nhớ chia sẻ]] cho phép nhiều [[luồng (thread)]] truy cập cùng một giá trị dữ liệu, tối ưu hóa hiệu suất.
# Đồng bộ hóa rào cản (Barrier Synchronization)
- Đồng bộ hóa tất cả các luồng trong một khối
	- __ syncthreads()
- Lệnh __ syncthreads() đảm bảo tất cả các luồng trong cùng một khối phải hoàn thành một [[pha (phase)]] trước khi tiếp tục.
- Được sử dụng để điều phối thuật toán dạng [[ô]], giúp:
	...
	- Đảm bảo rằng tất cả các phần tử của một ô dữ liệu đã được sử dụng trước khi tiếp tục [[pha (phase)]] tiếp theo.
