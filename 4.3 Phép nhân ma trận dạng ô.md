...
- Hãy nhớ rằng số phần tử trong mỗi khối N bằng với số [luồng] trong block [[luồng]]. Vì vậy, trong [[thuật toán]] nhân ma trận theo khối, chúng ta có thể để mỗi [[luồng]] nạp một phần tử của M và một phần tử của N.
...
- Chúng ta chọn khối 0,0 làm ví dụ tiêu biểu. Khối 0,0 sẽ có bốn [[luồng]] thực hiện tính toán để tạo ra các phần tử P00, P01, P10, P11, tức là ô vuông nhỏ ở góc trên bên trái của ma trận kết quả PP.
