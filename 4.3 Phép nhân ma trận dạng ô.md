...
- Cuối cùng, đây là quá trình thực thi vòng lặp 1 của pha 1. Trong vòng lặp này, tất cả các luồng sẽ truy cập bộ nhớ chia sẻ để lấy phần tử cuối cùng của ma trận MM và phần tử cuối cùng của ma trận NN cho tích vô hướng của chúng.

- Ví dụ, luồng Thread00 sẽ sử dụng M03M_{03} và N30N_{30} từ bộ nhớ chia sẻ để tính toán số hạng cuối cùng cho tích vô hướng của P00P_{00}.
