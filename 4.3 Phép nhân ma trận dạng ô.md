...
- Đối với \(A_{ij}\), luồng 00 sẽ lấy M00M_{00}M00​ và N00N_{00}N00​ từ bộ nhớ chia sẻ. Tương tự, đối với luồng 11, luồng này sẽ lấy M11M_{11}M11​ và N11N_{11}N11​ từ bộ nhớ chia sẻ để thực hiện một bước lặp của phép nhân vô hướng.
