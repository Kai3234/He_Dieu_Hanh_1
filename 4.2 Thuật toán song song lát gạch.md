...
7. Xác định một ô trong bộ nhớ toàn cục mà nhiều luồng cần truy cập.
    
8. Nạp ô đó từ bộ nhớ toàn cục vào bộ nhớ trên chip.
    
9. Sử dụng đồng bộ hóa rào cản để đảm bảo tất cả các luồng sẵn sàng trước khi bắt đầu giai đoạn tính toán.
    
10. Các luồng truy cập dữ liệu từ bộ nhớ trên chip thay vì bộ nhớ toàn cục.
    
11. Sử dụng đồng bộ hóa rào cản để đảm bảo tất cả các luồng hoàn thành giai đoạn hiện tại.
    
12. Chuyển sang ô tiếp theo và lặp lại quá trình.
