...
![[Pasted image 20250218145341.png]]
 Mẫu truy cập bộ nhớ toàn cầu của kernel nhân ma trận cơ bản. Điểm quan trọng là các luồng thường truy cập vào cùng một vị trí bộ nhớ cho các toán hạng đầu vào của chúng.
