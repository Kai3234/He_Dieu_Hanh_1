...
Sơ đồ cho thấy một mẫu truy cập bộ nhớ toàn cầu cho một kernel nhân ma trận cơ bản. Luồng 1 và Luồng 2 truy cập các phần tử khác nhau của các ma trận liên quan đến phép nhân.
