...
![[Pasted image 20250218150333.png]]- Đồng bộ hóa rào cản là một cơ chế kiểm soát rất quan trọng cho việc phân mảnh (tiling). Đồng bộ hóa rào cản cho phép tất cả  [[Các luồng (thread)]] trong một khối luồng có thể đồng bộ hóa thời gian của chúng, và tất cả sẽ được giữ lại tại rào cản cho đến khi tất cả các luồng đã đến điểm đó. Điều này liên quan đến việc phân mảnh vì đây là một cách để chúng ta đảm bảo rằng tất cả [[Các luồng (thread)]] đã sẵn sàng để bắt đầu một giai đoạn, hoặc tất cả các luồng đã hoàn thành việc thực thi một giai đoạn.
...
3. Sử dụng đồng bộ hóa rào cản để đảm bảo tất cả  [[Các luồng (thread)]] sẵn sàng trước khi bắt đầu giai đoạn tính toán.
    
4.  [[Các luồng (thread)]] truy cập dữ liệu từ bộ nhớ trên chip thay vì bộ nhớ toàn cục.
    
5. Sử dụng đồng bộ hóa rào cản để đảm bảo tất cả  [[Các luồng (thread)]] hoàn thành giai đoạn hiện tại.
