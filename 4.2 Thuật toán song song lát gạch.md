...
Sơ đồ cho thấy một mẫu truy cập bộ nhớ toàn cầu cho một kernel nhân ma trận cơ bản. Luồng 1 và Luồng 2 truy cập các phần tử khác nhau của các ma trận liên quan đến phép nhân.Sơ đồ minh họa cách các luồng truy cập dữ liệu từ bộ nhớ toàn cầu, điều này rất quan trọng trong việc tối ưu hóa hiệu suất nhân ma trận trên các kiến trúc song song như GPU. Truy cập bộ nhớ hiệu quả là chìa khóa để giảm thiểu độ trễ và tối đa hóa thông lượng.
