"Global memory" là một thuật ngữ thường được sử dụng trong lĩnh vực máy tính và lập trình, đặc biệt là trong ngữ cảnh của các hệ thống đa luồng hoặc lập trình song song. Nó thường chỉ đến một vùng nhớ mà tất cả các luồng hoặc tiến trình có thể truy cập. Dưới đây là một số điểm chính về global memory:

1. **Truy cập chung**: Global memory cho phép nhiều luồng hoặc tiến trình truy cập và chia sẻ dữ liệu. Điều này rất hữu ích trong các ứng dụng cần phối hợp giữa nhiều phần của chương trình.
