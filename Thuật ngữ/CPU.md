CPU (Central Processing Unit) là [[bộ xử lý]] trung tâm của máy tính. Nó được coi là "bộ não" của máy tính, thực hiện các lệnh và xử lý dữ liệu để điều khiển hoạt động của toàn bộ hệ thống.
