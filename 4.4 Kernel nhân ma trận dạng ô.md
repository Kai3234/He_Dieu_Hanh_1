...
// trong đó: 
- `blockIdx` là chỉ số của [[khối]] trong grid.
- `threadIdx` là chỉ số của [[luồng]] bên trong [[khối]].
- `blockDim.x` là số lượng [[luồng]] theo chiều ngang của [[khối]]
- `blockDim.y` là số lượng [[luồng]] theo chiều dọc của [[khối]].
