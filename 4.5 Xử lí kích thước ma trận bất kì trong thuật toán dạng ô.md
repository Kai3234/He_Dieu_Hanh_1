...
Điều này thực sự gợi ý rằng chúng ta cần có khả năng kiểm tra các điều kiện khác nhau cho mỗi luồng khi tải các phần tử ô khi thực hiện tính toán tích vô hướng và ghi vào phần tử đầu ra.
