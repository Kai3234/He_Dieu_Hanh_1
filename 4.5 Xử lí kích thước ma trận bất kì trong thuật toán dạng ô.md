...
- Với tất cả các điều kiện này được kiểm tra trong kernel, chúng ta mong đợi sẽ có sự phân kỳ điều khiển. Và ảnh hưởng của phân kỳ điều khiển sẽ nhỏ đối với các ma trận lớn.
