...
Khi tải ô M, chỉ số sẽ sử dụng trong ký hiệu hai chiều sẽ là M sử dụng cho hướng y và p lần chiều rộng ô cộng tx cho hướng x.
...
Khi tải ô n đầu vào, chỉ số 2D tương đương để tải phần tử n sẽ là p lần chiều rộng ô cộng ty cho hướng y và Col. cho hướng x.
