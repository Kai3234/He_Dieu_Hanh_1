...
Về mặt triển khai, bây giờ chúng ta có thể xem xét việc kiểm tra điều kiện biên để tải ô M đầu vào. Vì vậy, chúng ta thấy rằng chỉ số mà chúng ta sẽ sử dụng trong ký hiệu hai chiều sẽ là M sử dụng cho chỉ số y và p lần chiều rộng ô cộng tx cho chiều x.
