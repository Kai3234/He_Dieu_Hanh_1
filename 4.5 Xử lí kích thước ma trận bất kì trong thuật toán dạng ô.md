...
Sau khi tải gạch vào bộ nhớ chia sẻ, pha 1 của khối 00 sẽ sử dụng các phần tử M và N từ bộ nhớ chia sẻ. Và điều này chỉ được minh họa trong slide này. Vì vậy, đối với vòng lặp 0, các luồng sẽ tiêu thụ các phần tử m hợp lệ từ bộ nhớ chia sẻ. Vì vậy, điều này là tốt.
