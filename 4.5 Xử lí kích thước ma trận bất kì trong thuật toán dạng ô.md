...
# Các điểm quan trọng
Một là đối với mỗi luồng, các điều kiện để tải phần tử m, tải phần tử n và tính toán và lưu trữ các phần tử p đầu ra đều khác nhau.

Điều này cho phép mỗi luồng đóng một vai trò khác nhau khi tải gạch m, tải gạch n so với tính toán và lưu trữ phần tử p đầu ra.

Quan sát thứ hai là với tất cả các điều kiện này được kiểm tra trong kernel, chúng ta mong đợi sẽ có sự phân kỳ điều khiển.

Tuy nhiên, chúng ta cũng mong đợi rằng ảnh hưởng của phân kỳ điều khiển sẽ nhỏ đối với các ma trận lớn.
...
Chúng ta sẽ thấy một mức độ phân kỳ điều khiển, nhưng ảnh hưởng của chúng sẽ nhỏ đối với các ma trận lớn.
