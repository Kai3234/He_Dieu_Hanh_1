...
- **Trường hợp đầu tiên**: các [[luồng]] không tính toán các phần tử P hợp lệ, chúng vẫn cần tham gia [[tải ô|tải các phần tử ô]] đầu vào hợp lệ. 
	- Ví dụ, trong [[pha]] 0 của [[khối luồng|khối]] (1, 1), [[luồng]] (1, 0) được cho là tính toán P3,2 không tồn tại, vì vậy nó không tính toán bất kỳ phần tử P hợp lệ nào, nhưng nó vẫn cần tham gia tải phần tử gạch đầu vào N1,2.
