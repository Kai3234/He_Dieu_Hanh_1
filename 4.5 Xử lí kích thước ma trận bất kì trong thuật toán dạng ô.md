...
Bây giờ, chúng ta đã hoàn thành một hành trình, đi từ một [[kernel]] nhân ma trận đơn giản và thêm chức năng xếp gạch, kiểm tra điều kiện biên để có thể mở rộng khả năng xử lý các kích thước tùy ý và sau đó với một số thay đổi đơn giản, bây giờ chúng ta có thể xử lý các hình dạng đầu vào tùy ý của ma trận hình chữ nhật.
