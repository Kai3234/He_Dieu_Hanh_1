...
Với chiến lược mới, chúng ta thấy rằng ô mà chúng ta sẽ sử dụng trong pha 1 bởi khối 00, các vị trí bộ nhớ chia sẻ lẽ ra đã được chiếm bởi các phần tử M và N không tồn tại giờ đã được lấp đầy bằng các giá trị 0.
