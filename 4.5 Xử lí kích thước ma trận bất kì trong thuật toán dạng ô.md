...
- Thay thế đối số chiều rộng bằng ba đối số j, k, l
	...
	- Khi chiều rộng được sử dụng để chỉ chiều rộng của m và chiều cao của n, chúng ta thay thế nó bằng k.
	- Khi chiều rộng được sử dụng để chỉ chiều rộng của n hoặc chiều rộng của p, chúng ta thay thế nó bằng l.
