Câu 1. Giả sử một kernel được khởi động với 1000 khối [[luồng]], mỗi [[khối luồng|khối]] có 512 [[luồng]]. Nếu một [[biến]] được khai báo là [[biến]] [[bộ nhớ chia sẻ]], thì có bao nhiêu phiên bản của [[biến]] này sẽ được tạo ra trong suốt thời gian thực thi của [[Kernel|kernel]]?
a.      1
==b.==      1,000
c.      512
d.      512,000  
...
c.      64
d.      128
**Giải thích:** Đối với một [[ô]] A kích thước 32x32, mỗi hàng trong [[ô]] bao gồm 32 từ liên tiếp và được truy cập bởi một [[Warp|warp]]. Tổng lượng [[dữ liệu]] trong hàng chỉ là một burst duy nhất. Chúng ta có 32 hàng trong một [[ô]], vì vậy sẽ có 32 burst được gửi đến [[bộ xử lý]].
