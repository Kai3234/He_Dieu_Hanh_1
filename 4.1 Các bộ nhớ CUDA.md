...
Tất cả các đơn vị xử lý trong cùng một SM có quyền truy cập chung vào shared memory, điều này giúp tăng tốc độ giao tiếp giữa các luồng trong cùng một block.
