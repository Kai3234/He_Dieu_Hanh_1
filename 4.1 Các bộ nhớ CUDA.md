...
- Hình này mô tả cách lập trình viên nhìn nhận các cấp bộ nhớ trong mô hình lập trình CUDA của GPU, giúp hiểu cách các dữ liệu được lưu trữ và truy xuất trong môi trường tính toán song song.