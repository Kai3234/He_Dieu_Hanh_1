...
Bên trên là đoạn code dùng trong [[CUDA]] để làm mờ một hình ảnh bằng cách tính trung bình các pixel xung quanh một điểm ảnh cụ thể. Thuật toán trên giúp minh hoạ cho tầm quan trọng của hiệu quả truy cập bộ nhớ. 
