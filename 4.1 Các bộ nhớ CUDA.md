...
- Trong khi đó, các thanh ghi (Regist) và bộ nhớ chia sẻ không thể truy cập được bởi máy chủ và chúng được các luồng truy cập một cách nghiêm ngặt. Và vì vậy, chúng sẽ được khai báo trong kernel.
