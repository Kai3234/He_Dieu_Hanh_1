...
Đây là một đánh giá nhanh về nơi chúng ta nên khai báo mỗi loại biến bộ nhớ. Một cách nhanh chóng để xác định nơi đặt khai báo là hỏi liệu máy chủ có thể truy cập giá trị hay không