...
1. Thanh ghi (Registers):
  -  Mỗi luồng (ô màu xanh lá cây) có một bộ thanh ghi (Registers) riêng (màu cam) để lưu trữ giá trị trung gian khi thực hiện tính toán.
  - Thanh ghi là vùng nhớ nhanh nhất mà mỗi luồng có thể truy cập trực tiếp, điều này được thể hiện qua các mũi tên nhỏ giữa luồng và thanh ghi trong mỗi khối.