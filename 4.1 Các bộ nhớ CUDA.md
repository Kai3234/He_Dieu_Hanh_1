...
- Hình trên là một ví dụ cơ bản - ph ép nhân [[ma trận]] để minh hoạ việc sủ dụng hiệu quả các loại [[bộ nhớ]]. Sơ đồ cho thấy cách chia [[ma trận]] thành các [[khối]] với BLOCK_WIDTH và thực hiện [[tính toán song song]]. Trong đó: 
