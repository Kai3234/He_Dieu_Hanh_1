...
#### 3. Biến bộ nhớ toàn cục (Global Memory): 
   ...
   - Lưu ý quan trọng: Bộ nhớ toàn cục có độ trễ cao hơn  và Registers. Do đó, truy cập dữ liệu từ Global Memory có thể mất nhiều thời gian và yêu cầu các chiến lược đồng bộ phù hợp để đảm bảo tính nhất quán dữ liệu.
